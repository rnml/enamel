...
let pp_to_string w doc = sdoc_to_string (format w 0 [(0, Flat, agrp doc)])

let pp_to_file oc w doc = sdoc_to_file oc (format w 0 [(0, Flat, agrp doc)])
...
let print_doc w doc = pp_to_file stdout w doc
